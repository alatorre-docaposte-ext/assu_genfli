...
class Screen2Delivery:
    ...
    def _build_fiche(self, parent: ttk.Frame) -> None:
        ...
        f.grid(row=2, column=0, columnspan=2, sticky="nsew", pady=(4, 0))
    ...
    def _build_git_livraison(self, parent: ttk.Frame) -> None:
        ...
        f.grid(row=0, column=0, columnspan=2, sticky="ew", pady=(0, 8))
        f.columnconfigure(1, weight=1)
        ...
        session_commit_msg = prefs_mod.get(self._prefs, "session", "delivery", "commit_message", default="")
        self._commit_message_var = tk.StringVar(value=session_commit_msg)
        ttk.Entry(f, textvariable=self._commit_message_var).grid(row=1, column=1, sticky="ew", pady=5)
    ...
    def on_next(self) -> bool:
        ...
        delivery = {
            ...
            "commit_message":  self._commit_message_var.get(),
